...
// Shop.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CShopApp, CWinApp)
...
// Единственный объект CShopApp

CShopApp theApp;


// Инициализация CShopApp

BOOL CShopApp::InitInstance()
{
